...
def hand_type(hand):
    ...
    if char_counts[0] == 4:
        return 6
    if char_counts[0] == 3 and char_counts[1] == 2:
        return 5
    if char_counts[0] == 3 and char_counts[1] == 1:
        return 4
    if char_counts[0] == 2 and char_counts[1] == 2:
        return 3
    if char_counts[0] == 2 and char_counts[1] == 1:
        return 2
    return 1
    
def hand_score(hand):
    if hand_type(hand) is None:
        print(hand)
